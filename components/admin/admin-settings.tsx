...
export default function AdminSettings() {
  ...
  const [isParaphraserEnabled, setIsParaphraserEnabled] = useState(true)
  const [paraphraserDisabledMessage, setParaphraserDisabledMessage] = useState("The paraphrasing tool is currently undergoing maintenance. We expect to be back shortly. Thank you for your patience.")
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Paraphraser Tool Settings</CardTitle>
          <CardDescription>
            Enable or disable the paraphraser tool for all users and set a custom message.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between rounded-lg border p-4">
            <div className="space-y-0.5">
              <Label htmlFor="paraphraser-enabled" className="text-base">
                Paraphraser Tool
              </Label>
              <p className="text-sm text-muted-foreground">
                Enable or disable the paraphraser tool for all users.
              </p>
            </div>
            <Switch
              id="paraphraser-enabled"
              checked={isParaphraserEnabled}
              onCheckedChange={setIsParaphraserEnabled}
            />
          </div>
          <div className="space-y-2">
            ...
            <Textarea
              id="disabled-message"
              placeholder="Enter message to display when paraphraser is disabled"
              value={paraphraserDisabledMessage}
              onChange={(e) => setParaphraserDisabledMessage(e.target.value)}
              disabled={isParaphraserEnabled}
            />
            <p className="text-sm text-muted-foreground">
              This message will be shown to users if the paraphraser tool is disabled.
            </p>
          </div>
        </CardContent>
      </Card>
